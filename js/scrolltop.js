 ...
 *
 * scrolltop.js
 * Hatch's scrollup.js script shows and hides the "back to top" button whenever it reaches the page
...
window.onscroll = function() {
  if (pageYOffset >= 200) { // <-- offset threshold
    document.getElementById('icon-scroll-top').style.visibility = 'visible';
  }
  else {
    document.getElementById('icon-scroll-top').style.visibility = 'hidden';
    return;
  }
  document.getElementById('icon-scroll-top').onclick = function() {
